...
//  SDOSKeyedCodable
//
//  Created by Antonio Jesús Pallares on 02/13/2019.
...
class InitialViewController: UIViewController {
    ...
    private func loadContent() {
        ...
        lbVersion.text = String(format: NSLocalizedString("SDOSKeyedCodableExample.version", comment: ""), Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as! String)
        ...
        btnExample.setTitle(NSLocalizedString("SDOSKeyedCodableExample.btn.seeExample", comment: ""), for: .normal)
    }
